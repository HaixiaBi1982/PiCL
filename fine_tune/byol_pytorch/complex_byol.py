...
class ComplexBYOL(nn.Module):
    ...
    def _get_target_encoder(self):
        target_encoder = copy.deepcopy(self.original_online_encoder)  # 为啥这里直接decopy不行？
    ...
    def forward(
        ...
        with torch.no_grad():
            ...
            # print("online_predictor的requires_grd = {}".format(get_requires_grd(self.online_predictor)))
            # print("target_encoder的requires_grd = {}".format(get_requires_grd(target_encoder)))
